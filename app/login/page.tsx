      ...
      <div className="w-full max-w-sm space-y-8 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 sm:p-8">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button
            ...
            className="flex w-full items-center justify-center rounded-md bg-zinc-900 px-4 py-2 text-sm font-medium text-white transition-colors duration-150 hover:bg-zinc-700 disabled:cursor-not-allowed disabled:opacity-60 motion-reduce:transition-none dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-300"
          >
